...
public class SketchActivity extends Activity implements View.OnClickListener, View.OnTouchListener {
    ...
    private static final String KERAS_MODEL_FILENAME = "opt_mnist_convnet-keras.pb";
    private static final String KERAS_MODEL_FILE_PATH = ASSETS_FILE_DIRECTORY + "/" + KERAS_MODEL_FILENAME;

    private static final String TENSORFLOW_MODEL_FILENAME = "opt_mnist_convnet-tf.pb";
    private static final String TENSORFLOW_MODEL_FILE_PATH = ASSETS_FILE_DIRECTORY + "/" + TENSORFLOW_MODEL_FILENAME;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    mClassifiers.add(
                            TensorFlowClassifier.create("TensorFlow",
                                    TENSORFLOW_MODEL_FILE_PATH, LABELS_FILE_PATH, PIXEL_WIDTH, PIXEL_HEIGHT,
                                    "input", "output", true));
                    mClassifiers.add(
                            TensorFlowClassifier.create("Keras",
                                    KERAS_MODEL_FILE_PATH, LABELS_FILE_PATH, PIXEL_WIDTH, PIXEL_HEIGHT,
